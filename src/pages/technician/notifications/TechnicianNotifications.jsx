...
const TechnicianNotifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      // All notifications for technician (server should filter by user role)
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Notifikasi Teknisi</h1>
                <p className="mt-1 text-sm text-gray-600">
                  Kelola notifikasi maintenance dan repair Anda di sini
                </p>
              </div>
              ...
              <div className="p-12 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-500 text-sm">
                    {filter === 'all' ? 'Notifikasi maintenance dan repair akan muncul di sini ketika ada tugas baru.' :
