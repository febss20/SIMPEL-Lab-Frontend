      ...
      >
        ...
        >
          <div className="p-6 bg-gradient-to-r from-indigo-500/30 to-purple-500/30 text-white text-center border-b border-white/10">
            ...
            <p className="text-white/80 mt-1">Masuk ke akun Anda</p>
          </div>
          ...
          <div className="p-6">
            {successMessage && (
              <motion.div 
                ...
                className="bg-green-400/20 backdrop-blur-md border border-green-400/30 text-green-100 px-4 py-3 rounded-lg mb-6 flex items-start"
              >
          ...
          <div className="p-6 border-t border-white/10 bg-black/5">
            <div className="text-center">
              <Link to="/register" className="inline-flex items-center text-indigo-300 hover:text-white transition-colors">
                ...
                <span className="font-semibold ml-1 underline hover:text-indigo-200">Daftar Sekarang</span>
