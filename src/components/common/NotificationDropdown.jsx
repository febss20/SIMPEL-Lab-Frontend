...
const NotificationDropdown = ({ 
  ...
  return (
    <div className="absolute left-1/2 transform -translate-x-1/2 sm:left-auto sm:right-0 sm:transform-none mt-2 w-80 max-w-[calc(100vw-2rem)] bg-white rounded-lg shadow-lg border border-gray-200 z-50 animate-fadeIn">
      {/* Header */}
        ...
        {loading ? (
          ...
          <div className="p-6 sm:p-8 text-center">
            <div className="flex flex-col items-center">
              <svg className="h-10 w-10 sm:h-12 sm:w-12 text-gray-300 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
