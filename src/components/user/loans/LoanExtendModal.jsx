    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md animate-fadeIn max-h-[80vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">Perpanjang Peminjaman</h2>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">Tanggal Kembali Lama</label>
            <input
              type="text"
              value={oldEndDate}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Tanggal Kembali Baru</label>
            <input
              type="date"
              name="newEndDate"
